 ...
 */
class SM_Vendors_Model_Override_Sales_Resource_Report_Bestsellers extends Mage_Sales_Model_Resource_Report_Bestsellers
{
	public function aggregate($from = null, $to = null)
    {
        ...
        try {
            ...
            $columns = array(
                ...
                'product_vendor_id'           => new Zend_Db_Expr(
                    sprintf('MIN(%s)',
                        $adapter->getIfNullSql('product_vendor_id.value','product_default_vendor_id.value')
                    )
                ),
            ...
            // join product attributes Name & Price & Vendor Id
            ...
            $joinExprProductVendorId       = array(
                'product_vendor_id.entity_id = product.entity_id',
                'product_vendor_id.store_id = source_table.store_id',
            ...
            $joinExprProductDefaultVendorId = array(
                'product_default_vendor_id.entity_id = product.entity_id',
            ...
            $columns = array(
            	...
            	'product_vendor_id'                   => new Zend_Db_expr('MIN(product_vendor_id)'),
