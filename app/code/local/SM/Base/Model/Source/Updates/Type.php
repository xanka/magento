<?php
/**
 * @copyright  Copyright (c) 2010 SM (http://www.smartosc.com)
 */  
class SM_Base_Model_Source_Updates_Type extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
