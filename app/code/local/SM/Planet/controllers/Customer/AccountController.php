...
class SM_Planet_Customer_AccountController extends Mage_Customer_AccountController
{
    /**
    ...
    public function createPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            foreach($customers as $_cu) {
                if ($_cu->getEmail() == $params['email']) {
...
//                $customerErrors = $customerForm->validateData($customerData);
                ...
                if ($customerErrors !== true) {
                    ...
                    // Set default deliver area is UK
                    $customer->getData('delivery_area','a:1:{i:0;s:2:"GB";}');
...
//                        Mage::register('current_vendor_register',$params);
                        Mage::getSingleton('core/session')->setVendor($params);
                        $this->_redirectUrl(Mage::getUrl('vendor/*/create',array('name' => $params)));
                        return;
                    }
                    ...
                    Mage::register('register_customer',$customer);
                    ...
                    if ($customer->isConfirmationRequired()) {
                        ...
                        $this->_redirectSuccess(Mage::getUrl('*/*/index', array('_secure'=>true,'email' => Mage::helper('customer')->getEmailConfirmationUrl($customer->getEmail()))));
                        return;
                    } else {
    ...
    public function editPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($customerErrors !== true) {
                ...
                $customerForm->compactData($customerData);
                $errors = array();
                //apply change for filter product by vendor delivery area
                $filterProduct = $this->getRequest()->getPost('filterproduct');
                $customer->setData('filterproducbyareat',$filterProduct);
