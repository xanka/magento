...
class Company_Web_Block_Adminhtml_Answer_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('answer_data') && Mage::registry('answer_data')->getId() ) {
            return Mage::helper('web')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('answer_data')->getTitle()));
        } else {
