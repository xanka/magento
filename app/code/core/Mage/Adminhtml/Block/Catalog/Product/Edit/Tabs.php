    ...
    protected function _prepareLayout()
    {
        ...
        if ($setId) {
            $groupCollection = Mage::getResourceModel('eav/entity_attribute_group_collection')
                ...
                ->setSortOrder()
               // ->addFieldToFilter('attribute_group_id',array('in'=>array('6','8'))) // using 'in' instead of 'nin' will only return these tabs, 6 and 8
                ->load();
            ...
            if (Mage::helper('core')->isModuleEnabled('Mage_CatalogInventory')) {
                $this->addTab('inventory', array(
                    'label'     => Mage::helper('catalog')->__('Stock Level'),
