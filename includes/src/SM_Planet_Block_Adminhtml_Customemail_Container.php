 ...
 * @author tungvm
 */
class SM_Planet_Block_Adminhtml_Customemail_Container extends Mage_Adminhtml_Block_Widget_Container
{
    protected $_mode = 'edit';
    protected $_blockGroup = 'planet';
    protected $_controller = 'adminhtml_customemail';
    protected $_headerText = 'Custom and send rejected email';
