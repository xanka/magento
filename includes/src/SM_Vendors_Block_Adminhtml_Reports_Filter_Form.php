...
class SM_Vendors_Block_Adminhtml_Reports_Filter_Form extends Mage_Adminhtml_Block_Report_Filter_Form
{
/**
...
//                $vendors[] = array('label'=>'','value'=>'');
            ...
            $fieldset->addField('vendors', 'select', array(
                'name'      => 'vendors',
            	'label'     => Mage::helper('smvendors')->__('Vendors'),
                'values'    => $vendors,
            ));
