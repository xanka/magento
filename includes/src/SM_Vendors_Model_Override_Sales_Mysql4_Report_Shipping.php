 ...
 */
class SM_Vendors_Model_Override_Sales_Mysql4_Report_Shipping extends Mage_Sales_Model_Resource_Report_Abstract
{
    /**
    ...
    protected function _aggregateByOrderCreatedAt($from, $to)
    {
        ...
        // merge original order table and order of vendor
        $sel = clone $adapter->select();
        $sel
            ->from(array('ven' => $vendorOrderTable),array(
            'ven_base_shipping_amount' => 'base_shipping_amount',
            'ven_base_shipping_invoiced' => 'base_shipping_invoiced',
            'ven_base_shipping_refunded' => 'base_shipping_refunded',
            'vendor_id'));
        ...
        try {
            ...
            $columns = array(
                ...
                'total_shipping'        => new Zend_Db_Expr(
                    "SUM((ven_base_shipping_amount - {$ifnullBaseShippingCanceled}) * base_to_global_rate)"),
                'total_shipping_actual' => new Zend_Db_Expr(
                    "SUM((ven_base_shipping_invoiced - {$ifnullBaseShippingRefunded}) * base_to_global_rate)"),
                'vendor_id'             => 'vendor_id'
            );
    ...
    protected function _aggregateByShippingCreatedAt($from, $to)
    {
        ...
        try {
            ...
            $columns = array(
                ...
                'total_shipping'        => new Zend_Db_Expr('SUM((order_table.ven_base_shipping_amount - '
                    . "{$ifnullBaseShippingCanceled}) * order_table.base_to_global_rate)"),
                'total_shipping_actual' => new Zend_Db_Expr('SUM((order_table.ven_base_shipping_invoiced - '
