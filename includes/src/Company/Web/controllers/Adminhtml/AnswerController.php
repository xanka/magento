...
class Company_Web_Adminhtml_AnswerController extends Mage_Adminhtml_Controller_action
{
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['filename']['name']) && $_FILES['filename']['name'] != '') {
				try {	
					...
					$path = Mage::getBaseDir('media') . DS .'planet' . DS ;
...
//	  			$data['image_url'] = $_FILES['filename']['name'];
                $data['image_url'] = 'planet' . DS . $_FILES['filename']['name'];
			}
